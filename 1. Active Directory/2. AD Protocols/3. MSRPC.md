...
![](../Image/Pasted%20image%2020250823190404.png)
...
![](../Image/Pasted%20image%2020250823151519.png)
...
`smb2.cmd == 1` (for SMB2 Session Setup) or `smb.cmd == 0x73` (for SMBv1)
...
![](../Image/Pasted%20image%2020250823171051.png)

**The relation of Named Pipe + DCE/RPC:** 
```
TCP/445 → SMB → DCOM -> Named Pipe (\pipe\samr) → DCE/RPC → SAMR service
```
